        ...
        <div class="form-group form-grid-full">
            ...
            <div class="image-upload-wrapper">
                ...
                <div class="image-preview-container" id="imagePreviewContainer" onclick="document.getElementById('thumbnail').click()">
                    <div class="image-preview-placeholder" style="{{ $post->thumbnail ? 'display: none;' : '' }}">
                    ...
                    <img id="imagePreview" class="image-preview-img" src="{{ $post->thumbnail ? asset('storage/' . $post->thumbnail) : '' }}" style="{{ $post->thumbnail ? '' : 'display: none;' }}">

                    <div class="image-info" id="imageInfo" style="{{ $post->thumbnail ? 'display: flex;' : 'display: none;' }}">
                        <div class="image-info-content">
                            <span id="imageName" class="image-name">{{ $post->thumbnail ? basename($post->thumbnail) : '' }}</span>
                        </div>
